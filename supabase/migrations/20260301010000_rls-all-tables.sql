...
DROP POLICY IF EXISTS service_role_teams ON public.teams;
CREATE POLICY service_role_teams ON public.teams
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_titles ON public.titles;
...
DROP POLICY IF EXISTS service_role_team_memberships ON public.team_memberships;
CREATE POLICY service_role_team_memberships ON public.team_memberships
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_milestones ON public.milestones;
CREATE POLICY service_role_milestones ON public.milestones
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_quarterly_goals ON public.quarterly_goals;
CREATE POLICY service_role_quarterly_goals ON public.quarterly_goals
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_key_results ON public.key_results;
CREATE POLICY service_role_key_results ON public.key_results
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_project_links ON public.project_links;
CREATE POLICY service_role_project_links ON public.project_links
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_team_arrangements ON public.team_arrangements;
CREATE POLICY service_role_team_arrangements ON public.team_arrangements
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_arrangement_teams ON public.arrangement_teams;
CREATE POLICY service_role_arrangement_teams ON public.arrangement_teams
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_arrangement_assignments ON public.arrangement_assignments;
CREATE POLICY service_role_arrangement_assignments ON public.arrangement_assignments
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_github_syncs ON public.github_syncs;
CREATE POLICY service_role_github_syncs ON public.github_syncs
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_contributor_stats ON public.contributor_stats;
CREATE POLICY service_role_contributor_stats ON public.contributor_stats
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_meeting_templates ON public.meeting_templates;
CREATE POLICY service_role_meeting_templates ON public.meeting_templates
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_milestone_assignments ON public.milestone_assignments;
CREATE POLICY service_role_milestone_assignments ON public.milestone_assignments
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_quarterly_goal_assignments ON public.quarterly_goal_assignments;
CREATE POLICY service_role_quarterly_goal_assignments ON public.quarterly_goal_assignments
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_pending_invites ON public.pending_invites;
CREATE POLICY service_role_pending_invites ON public.pending_invites
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_favorite_projects ON public.favorite_projects;
CREATE POLICY service_role_favorite_projects ON public.favorite_projects
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_project_owners ON public.project_owners;
CREATE POLICY service_role_project_owners ON public.project_owners
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_person_goals ON public.person_goals;
CREATE POLICY service_role_person_goals ON public.person_goals
  FOR ALL TO service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS service_role_person_accomplishments ON public.person_accomplishments;
