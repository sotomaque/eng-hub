...
[Biome](https://biomejs.dev) handles both linting and formatting across the entire monorepo.
...
[Knip](https://knip.dev) detects unused exports, files, and dependencies.
...
[Lefthook](https://lefthook.dev) manages git hooks. Hooks are installed automatically on `bun install` via the `prepare` script.
